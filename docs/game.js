...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "game.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "game.wasm", {credentials: "same-origin"} );
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_4b7ee8160257c772a77dd2ed6947da30aebb4242": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);($0).imageSmoothingEnabled=false;
            },
            ...
            "__cargo_web_snippet_4d733095b1f4c106b2b6ecc253e2fdc464303921": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);window.addEventListener("resize",()=>{console.log("resize");($0)();});
            },
